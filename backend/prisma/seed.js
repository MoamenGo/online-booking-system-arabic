// backend/prisma/seed.js - بيانات تجريبية عربية
...
async function main() {
  ...
  await prisma.dayOff.upsert({
    where: { businessId_date: { businessId: business.id, date: friday } },
    update: {},
    create: {
      businessId: business.id,
      date: friday,
  ...
  console.log('✅ تم إضافة يوم إجازة يوم الجمعة');
